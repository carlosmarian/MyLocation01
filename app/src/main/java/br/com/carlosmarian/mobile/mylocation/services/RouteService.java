package br.com.carlosmarian.mobile.mylocation.services;
...
import br.com.carlosmarian.mobile.mylocation.database.DatabaseQuery;
import br.com.carlosmarian.mobile.mylocation.util.CustomSharedPreference;
import br.com.carlosmarian.mobile.mylocation.view.RecordResultActivity;
...
public class RouteService extends Service implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    public void onCreate() {
        super.onCreate();
        customSharedPreference = CustomSharedPreference.getInstance(getApplicationContext());
